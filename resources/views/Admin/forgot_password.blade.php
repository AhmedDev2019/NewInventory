...
<head>
  ...
  <title>{{ trans('backend.forgot_password') }}</title>
...
<span id="datatable"></span>
  ...
  <div class="login-logo" style="margin-top:40px">
    ...
    <a href="#" style="color:#367fa9;font-size:30px"> <i class="fa fa-key"></i> <b>{{ trans('backend.forgot_password') }}</b></a><br>
  ...
  <div class="login-box-body">
    <p class="login-box-msg">
        <div class="text-center">
          <img style="width:150px;border-radius:5px" src="{{ asset('uploads/logos/default.png') }}" alt="">
        </div>
    </p>

    <form id="myLoginForm" action="{{ route('admin.forgot_password_post') }}" method="post">
      ...
      <div class="form-group has-feedback">
        <input style="margin-bottom:5px" type="email" name="email" value="{{ old('email') }}" class="form-control {{ $errors->has('email') ? 'is-invalid-login' : '' }}" placeholder="{{ trans('backend.email') }}">
