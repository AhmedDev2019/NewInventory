                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="name_en" id="name_en" class="form-control {{ $errors->has('name_en') ? 'is-invalid' : '' }}" value="{{ $brand->name_en }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="imagePreview">
                                <img style="width:250px;height:200px;margin-top:5px;object-fit:contain" class="image-preview img-thumbnail" src="{{ asset($brand->logo) }}" alt="">
                            </div>
                        </div>
                    </div>
