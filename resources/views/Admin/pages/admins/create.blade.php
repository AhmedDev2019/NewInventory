...
@section('content')
    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <form id="myForm" action="{{ route('admin.admins.store') }}" method="POST" class="userForm" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{ method_field('POST') }}
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="imagePreview">
                                <img style="width:250px;height:200px;margin-top:5px;object-fit:contain" class="image-preview img-thumbnail" src="{{ asset('uploads/admins/default.png') }}" alt="">
                            </div>
                        </div>
                    </div>
