...
@section('pageTitle') 
    <i class="fa fa-eye"></i> {{ trans('backend.show') }} {{ trans('backend.admin') }} 
@endsection
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="first_name" style="color:#337ab7"><b>{{ trans('backend.first_name') }}</b></label>
                                    <h4 style="margin:0">{{ $admin->first_name }}</h4>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="first_name" style="color:#337ab7"><b>{{ trans('backend.last_name') }}</b></label>
                                    <h4 style="margin:0">{{ $admin->last_name }}</h4>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
