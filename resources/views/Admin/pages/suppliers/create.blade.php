...
@section('pageTitle') 
    <i class="fa fa-plus-circle"></i> {{ trans('backend.add') }} {{ trans('backend.suppliers') }} 
@endsection
...
@section('content')
    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <form id="myForm" action="{{ route('admin.suppliers.store') }}" method="POST" class="userForm" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{ method_field('POST') }}
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="supplier_type" id="supplier_type" class="form-control select2" style="width:100%">
                                <option value="">..........</option>
                                <option value="person" {{ old('supplier_type') == 'person' ? 'selected' : '' }}>{{ trans('backend.person') }}</option>
                                <option value="company" {{ old('supplier_type') == 'company' ? 'selected' : '' }}>{{ trans('backend.company') }}</option>
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="imagePreview">
                                <img style="width:200px;height:150px;margin-top:5px;object-fit:contain" class="image-preview img-thumbnail" src="{{ asset('uploads/suppliers/default.png') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
